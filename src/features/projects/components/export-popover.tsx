...
import { CheckCircle2Icon, CheckCircleIcon, ExternalLinkIcon, LoaderIcon, XCircleIcon } from "lucide-react";
...
export const ExportPopover = ({projectId} : ExportPopoverProps) => {
        ...
        onSubmit: async({value}) => {
            try {
                await ky
                    ...
                    toast.error("Unable to export respository") ;
            }
        },
    });
    ...
    const getStatusIcon = () => {
        ...
        if(exportStatus === "completed") {
            return <LoaderIcon className="size-3.5 text-emerald-500" />
        }
        if(exportStatus === "failed") {

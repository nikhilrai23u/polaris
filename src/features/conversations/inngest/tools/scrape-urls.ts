...
export const createScrapeUrlsTool = () => {
    return createTool({
        name: "scrapeUrls" , 
        description: 
            "Scrape contents from URLs to get documentation or  reference material. Use this when the user provides URLs or reference external documentation. Return markdown content from the scraped pages." ,
        parameters: z.object({
